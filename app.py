...
st.markdown("""
    ...
    .stock-id { font-size: 1.2rem !important; color: #666 !important; font-weight: normal !important; }
    ...
    .stTextInput label { color: #ffffff !important; text-shadow: 1px 1px 2px black; font-weight: bold; font-size: 1.1rem; }
