...
st.markdown("""
    <style>
    /* 全局字體 */
    .stApp { color: #333; font-family: sans-serif; }
    ...
    .price-big { font-size: 3.5rem !important; font-weight: 800 !important; line-height: 1.1; margin: 10px 0; }
    ...
    .stat-val { font-weight: bold !important; color: #000 !important; font-size: 1.1rem !important; }
    ...
    .stTextInput label { color: #fff !important; text-shadow: 1px 1px 3px black; font-weight: bold; font-size: 1.1rem; }
    ...
    .stRadio div[role="radiogroup"] > label p {
        color: #555 !important; /* 預設深灰字 */
        font-weight: bold; font-size: 0.95rem;
    }
    .stRadio div[role="radiogroup"] > label[data-checked="true"] {
        background-color: #26a69a !important; /* 選中綠底 */
    }
    .stRadio div[role="radiogroup"] > label[data-checked="true"] p {
        color: #ffffff !important; /* 選中白字 */
    }
    ...
    .news-item a { text-decoration: none; color: #0056b3 !important; font-weight: bold; font-size: 1.15rem; }
    .news-meta { font-size: 0.9rem !important; color: #666 !important; margin-top: 5px; }

    /* 主標題 */
    h1 { text-shadow: 3px 3px 6px #000; color: white !important; margin-bottom: 20px; }
...
if target:
    try:
        ...
        with tab1:
            ...
            # 預設顯示最近 100 根
            if len(df) > 100:
                fig.update_xaxes(range=[df.index[-100], df.index[-1]], row=1, col=1)
